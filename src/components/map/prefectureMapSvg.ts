// Source: https://github.com/geolonia/japanese-prefectures (map-full.svg)
// 各 <g data-code="1"〜"47"> は src/lib/constants.ts の LOCATIONS 配列の並び順（JIS都道府県コード順）と一致する。
export const PREFECTURE_MAP_SVG_INNER = `
