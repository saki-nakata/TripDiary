...
export function setup() {
  ...
  return { headers, paginationHeaders };
}

export function smokeSequence(data: { headers: ReturnType<typeof login>; paginationHeaders: ReturnType<typeof login> }): void {
  ...
  paginationScenario(data.paginationHeaders);
}
